  ...
  return (
    <section className="page-container mt-14">
      <div className="grid gap-6 rounded-[26px] border border-slate-200 bg-white p-6 shadow-[0_18px_42px_rgba(15,23,42,0.06)] lg:grid-cols-[0.8fr_1.2fr] md:p-8">
        <div>
          <span className="text-xs font-black uppercase tracking-[0.16em] text-[#0b3a6f]">Danışmanlık</span>
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={submit}>
          ...
          <button className="rounded-[14px] bg-[#0b3a6f] px-6 py-3 text-sm font-black text-white shadow-[0_14px_26px_rgba(11,58,111,0.20)] md:col-span-2" type="submit">
            Talebi Kaydet
          </button>
          {saved ? <p className="text-sm font-semibold text-[#0b3a6f] md:col-span-2">Talebiniz kaydedildi.</p> : null}
        </form>
      </div>
    </section>
  );
