...
function FeatureCard({
  ...
  return (
    <a
      href={href}
      className="group relative rounded-[26px] border border-[#d9e4ee] bg-white/94 px-6 py-7 text-center shadow-[0_18px_40px_rgba(15,35,70,0.09)] backdrop-blur-[3px] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_52px_rgba(15,35,70,0.14)]"
    >
      <div className="mx-auto mb-5 grid h-16 w-16 place-items-center rounded-[18px] border border-[#bfd2ef] bg-[linear-gradient(180deg,#f8fbff_0%,#eaf3ff_100%)] text-[#155eef] shadow-[0_10px_22px_rgba(21,94,239,0.10)] transition-transform duration-300 group-hover:scale-[1.03]">
        {icon}
      </div>
...
export function HeroSection() {
  return (
    <section className="page-container mt-5">
      <div className="overflow-hidden rounded-[30px] border border-[#d9e4ee] bg-white shadow-[0_12px_34px_rgba(15,35,70,0.08)]">
        <div className="relative grid min-h-[472px] gap-10 px-6 py-7 md:px-10 md:py-9 lg:grid-cols-[1.03fr_0.97fr] lg:px-12 lg:py-10">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_7%_14%,rgba(217,164,65,0.24),transparent_22%),radial-gradient(circle_at_88%_82%,rgba(21,94,239,0.14),transparent_20%),linear-gradient(180deg,#f8fbff_0%,#eef4fb_100%)]" />
          <div className="absolute inset-0 opacity-45 [background-image:radial-gradient(rgba(21,94,239,0.12)_1px,transparent_1px)] [background-size:20px_20px]" />

          <div className="relative z-10 flex min-h-[320px] flex-col justify-center pt-2">
            <span className="mb-6 inline-flex w-fit rounded-full border border-[#bfd2ef] bg-[#eaf3ff] px-4 py-2 text-[14px] font-semibold text-[#0b3a6f] shadow-[0_6px_16px_rgba(21,94,239,0.09)]">
            ...
            <h1 className="max-w-[560px] text-[clamp(44px,6vw,72px)] font-black leading-[0.9] tracking-[-0.065em] text-[#09132a]">
              ...
              Finansmanının
              <br />
              <span className="text-[#155eef]">Gerçek Maliyetini</span>
              <br />
              Hesaplayın
            </h1>

            <p className="mt-6 max-w-[590px] text-[18px] leading-8 text-[#55657b]">
              <span className="font-bold text-[#0b3a6f]">Enflasyondan</span> arındırılmış net maliyet analizi, banka
          ...
          <div className="relative z-10 flex items-center justify-center lg:justify-end">
            <div className="pointer-events-none absolute inset-y-3 right-0 hidden w-[94%] rounded-[34px] bg-[radial-gradient(circle_at_84%_83%,rgba(217,164,65,0.18),transparent_25%),linear-gradient(145deg,rgba(234,243,255,0.76),rgba(247,251,255,0.08))] lg:block" />
            <div className="pointer-events-none absolute right-[8%] top-[2%] hidden h-[90%] w-[68%] lg:block">
              ...
              <div className="absolute bottom-[8%] right-[4%] h-[22%] w-[36%] rounded-[999px_999px_18px_18px] bg-[linear-gradient(90deg,rgba(255,255,255,0.96),rgba(217,164,65,0.44))] opacity-95" />
              <div className="absolute bottom-[2%] right-[6%] h-[20%] w-[38%] rounded-full bg-[radial-gradient(circle,rgba(21,94,239,0.18),transparent_68%)] blur-2xl" />
            </div>
