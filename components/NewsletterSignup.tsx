...
export function NewsletterSignup({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <section className={compact ? "" : "page-container mt-14"}>
      <div className="rounded-[26px] border border-emerald-100 bg-[linear-gradient(135deg,#f2fff7_0%,#ffffff_56%,#f6fbff_100%)] p-6 shadow-[0_18px_42px_rgba(15,23,42,0.06)] md:p-8">
        <div className="grid gap-5 lg:grid-cols-[1fr_420px] lg:items-center">
          <div>
            <span className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">Bülten</span>
          ...
          <form className="grid gap-3 sm:grid-cols-[1fr_auto]" onSubmit={submit}>
            <input
              ...
              value={email}
            />
            <button className="rounded-[14px] bg-[#16a05a] px-6 py-3 text-sm font-black text-white shadow-[0_14px_26px_rgba(22,160,90,0.18)]" type="submit">
              Kaydol
            </button>
