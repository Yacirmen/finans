...
export function CalculatorSection() {
  return (
    <section id="calculator" className="page-container relative z-20 mt-10 scroll-mt-24 lg:mt-12" data-calculator>
      <div className="mx-auto max-w-[900px] rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.12)] md:p-8" data-calculator-card>
